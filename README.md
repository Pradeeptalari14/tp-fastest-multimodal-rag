# ⚡ Fastest-Multimodal-Rag

> Extractor dividing text, tables, and image elements into separate document stores using LlamaIndex.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/fastest-multimodal-rag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-fastest-multimodal-rag.git
cd tp-fastest-multimodal-rag
```
...
```bash
kubectl port-forward deployment/tp-fastest-multimodal-rag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── multimodal_rag.py     # Main configuration file
```
...
---
*Generated by [Fastest-Multimodal-Rag Studio](https://pradeeptalari14.github.io/portfolio/tools/fastest-multimodal-rag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
